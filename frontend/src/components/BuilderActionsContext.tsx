...
export function CollapseToggle({
  ...
  return (
    <button
      ...
      className={`nodrag flex h-5 shrink-0 items-center gap-0.5 rounded-md bg-white font-display text-[11px] font-bold leading-none text-accent-strong shadow-subtle transition-colors hover:bg-sky ${
